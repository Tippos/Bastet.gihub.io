    ...
    public function run()
    {
        $data = [
            [
                ...
                'description' => 'Muon be toi hay cho toi 1 bat hat!!!',
                'created_at' => now()
            ],
            [
                'id' => 2,
                ...
                'description' => 'Dung de toi thay mat con Pho ><',
                'created_at' => now()
            ],
            [
                'id' => 3,
                ...
                'description' => 'Hit 1 cai phe ca ngay',
                'created_at' => now()
            ],
            [
                'id' => 4,
                ...
                'description' => 'Ngoan nhat quan roi !!!',
                'created_at' => now()
            ],
            [
                'id' => 5,
                ...
                'description' => 'Omachi chu khong phai omachi',
                'created_at' => now()
            ]
        ];
        Cats::insert($data);
