...
class CatsController extends Controller
{
    ...
    public function findId($id)
    {
        ...
        return view('admin-page/admin/cat/upCat', compact('c'));
    }
    ...
    public function addCat(Request $request)
    {
        ...
        try {
            ...
            $add_cat->weightCat=$request->weightCat;
            $add_cat->save();
        } catch (ModelNotFoundException $ex) {
            return response()->json([], SC_QUERRY_ERROR); //page not found
        } catch (\Exception $ex) {
    ...
    public function upCat(Request $request, $id)
    {
        ...
        try {
            ...
            $up_cat->weightCat=$request->weightCat;
            $up_cat->save();
        } catch (ModelNotFoundException $ex) {
            return response()->json([], SC_QUERRY_ERROR); //page not found
        } catch (\Exception $ex) {
    ...
    public function find(Request $request)
    {
        ...
        return view('admin-page/admin/cat/findCat', compact('list_cat'), compact('key'));
    }
}
